    ...
    <div>
      ...
      <div className="card">
        ...
        <ol style={{ paddingLeft: 18, marginTop: 8 }}>
          ...
          <li>{t('Waiting order to be delivered in 2 - 3 weeks. (You can speedup the order to be fulfilled within 7 days with extra processing/shipping cost of SGD70)')}</li>
        </ol>
      </div>
    </div>
  );
